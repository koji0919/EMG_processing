...
class NMF():
    ...
    def IS(self):
        # ISの更新式のWの分子について. 分子はij*jkをして、これを転地することでkiの行列を作成
...
nmf = NMF()
nmf.init_param(df=[[3,1,1.5,1,1,6,1,7,9,6,5,9], [2,1,4,1,1,2,1,1,3,4,6,2], [2,5,1,1,2,7,1,7,9,6,11,5],[2,7,1,1,4,7,4,7,13,6,14,8]], k=2, rms_flag=False,rms_t=30)
nmf.NMF_solve(2000,1)
# inport EMG File
